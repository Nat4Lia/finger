...
lcd_.printLCD('Starting v1.1g','%c %c %c' % (32, 32, 32)).lcd_status()
time.sleep(3)
lcd_.printLCD('Starting v1.1g','%c %c %c' % (46, 32, 32)).lcd_status()
time.sleep(4)
lcd_.printLCD('Starting v1.1g','%c %c %c' % (46, 46, 32)).lcd_status()
time.sleep(5)
lcd_.printLCD('Starting v1.1g','%c %c %c' % (46, 46, 46)).lcd_status()
