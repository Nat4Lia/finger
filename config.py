...
fp_payload = {
    ...
    'GetUserTemplate': '<GetUserTemplate>'
                       ...
                       '<FingerID xsi:type=\"xsd:integer\">%s</FingerID>'
                       '</Arg>'
                       '</GetUserTemplate>',
    ...
    'SetUserInfoPass': '<SetUserInfo>'
                       ...
                       '<Name>%s</Name>'
                       '<Password>%s</Password>'
                       '<Group>1</Group><Privilege>'
                       '</Privilege>'
                       '<Card></Card>'
                       '<PIN2>%s</PIN2>'
                       '<TZ1></TZ1><TZ2></TZ2><TZ3></TZ3>'
                       '</Arg>'
                       '</SetUserInfo>',
    ...
    'ClearData': '<ClearData>'
                 '<ArgComKey xsi:type=\"xsd:integer\">0</ArgComKey>'
                 '<Arg><Value xsi:type=\"xsd:integer\">%s</Value></Arg>'
                 '</ClearData>',
    'GetOption': '<GetOption>'
                 '<ArgComKey xsi:type=\"xsd:integer\">0</ArgComKey>'
                 '<Arg><Name xsi:type=\"xsd:string\">%s</Name></Arg>'
                 '</GetOption>',
...
SQL_SYNTAX = {
    'ADDPEGAWAI': 'INSERT INTO pegawai (user_pin2, user_name, mac_) '
                  'VALUES (%s, %s, %s)',
    'ADDADMIN': 'INSERT INTO pegawaiAdmin (user_pin2, user_name, mac_) '
                'VALUES (%s, %s, %s)',
    ...
    'DELETEPEGAWAI': 'DELETE FROM pegawai '
                     'WHERE user_pin2 = (%s) AND mac_ = (%s)',
    'DELETEPEGAWAIID': 'DELETE FROM pegawai WHERE id = (%s) AND mac_ = (%s)',
    'DELETEADMIN': 'DELETE FROM pegawaiAdmin '
                   'WHERE user_pin2 = (%s) AND mac_ = (%s)',
    'DELETEADMINID': 'DELETE FROM pegawaiAdmin '
                     'WHERE id = (%s) AND mac_ = (%s)',
    ...
    'FINDADMIN': 'SELECT user_pin2 FROM pegawaiAdmin '
                 'WHERE user_pin2 = (%s) AND mac_ = (%s)',
    'FINDPEGAWAI': 'SELECT user_pin2 FROM pegawai '
                   'WHERE user_pin2 = (%s) AND mac_ = (%s)',
    'FINDPEGAWAIALL': 'SELECT * FROM pegawai '
                      'WHERE user_pin2 = (%s) AND mac_ = (%s)',
    'FINDADMINALL': 'SELECT * FROM pegawaiAdmin '
                    'WHERE user_pin2 = (%s) AND mac_ = (%s)',
